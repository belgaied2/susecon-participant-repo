...
| Information | Value |
| --- | --- |
| Rancher URL | [https://rancher-veiq8.susecon2024.work](https://rancher-veiq8.susecon2024.work) |
| Rancher Web UI Username | admin |
| Rancher Password | `pDeTAC4o2EM1Bk` | 
| Harvester Node 1 IP | 145.40.93.213 | 
| All Nodes SSH User | rancher |
| All Nodes SSH Password | `jEcdaRwB6V8yeMhQ` |
| Router VM Public IP | 147.28.226.157 |
